...
cs0=axs[0].scatter(sstG75300.sel(time=slice(Tdateb[1],Tdatee[1])), sst75300.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs1=axs[0].scatter(sstG75300.sel(time=slice(Tdateb[2],Tdatee[2])), sst75300.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs2=axs[0].scatter(sstG75300.sel(time=slice(Tdateb[3],Tdatee[3])), sst75300.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs3=axs[0].scatter(sstG75300.sel(time=slice(Tdateb[4],Tdatee[4])), sst75300.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs4=axs[0].scatter(sstG75300.sel(time=slice(Tdateb[5],Tdatee[5])), sst75300.sel(time=slice(Tdateb[5],Tdatee[5])) , \
...
cs0=axs[1].scatter(sstG075.sel(time=slice(Tdateb[1],Tdatee[1])), sst075.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',linewidth=2.0,s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,ec='m')
cs1=axs[1].scatter(sstG075.sel(time=slice(Tdateb[2],Tdatee[2])), sst075.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',linewidth=2.0,s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,ec='c')
cs2=axs[1].scatter(sstG075.sel(time=slice(Tdateb[3],Tdatee[3])), sst075.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',linewidth=2.0,s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,ec='c')
cs3=axs[1].scatter(sstG075.sel(time=slice(Tdateb[4],Tdatee[4])), sst075.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',linewidth=2.0,s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,ec='m')
cs4=axs[1].scatter(sstG075.sel(time=slice(Tdateb[5],Tdatee[5])), sst075.sel(time=slice(Tdateb[5],Tdatee[5])) , \
...
cs0=axs[2].scatter(chlG75300.sel(time=slice(Tdateb[1],Tdatee[1])), chl75300.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs1=axs[2].scatter(chlG75300.sel(time=slice(Tdateb[2],Tdatee[2])), chl75300.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs2=axs[2].scatter(chlG75300.sel(time=slice(Tdateb[3],Tdatee[3])), chl75300.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs3=axs[2].scatter(chlG75300.sel(time=slice(Tdateb[4],Tdatee[4])), chl75300.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs4=axs[2].scatter(chlG75300.sel(time=slice(Tdateb[5],Tdatee[5])), chl75300.sel(time=slice(Tdateb[5],Tdatee[5])) , \
  c='w',s=90,marker='P',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
###
axs[3].scatter(chl075,chlG075, c='w' ,s=60,linewidth=2.0,edgecolors='black')
cs0=axs[3].scatter(chlG075.sel(time=slice(Tdateb[1],Tdatee[1])), chl075.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs1=axs[3].scatter(chlG075.sel(time=slice(Tdateb[2],Tdatee[2])), chl075.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs2=axs[3].scatter(chlG075.sel(time=slice(Tdateb[3],Tdatee[3])), chl075.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs3=axs[3].scatter(chlG075.sel(time=slice(Tdateb[4],Tdatee[4])), chl075.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs4=axs[3].scatter(chlG075.sel(time=slice(Tdateb[5],Tdatee[5])), chl075.sel(time=slice(Tdateb[5],Tdatee[5])) , \
  c='w',s=90,marker='P',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
###
axs[4].scatter(hld75300,hldG75300, c='w' ,s=60,linewidth=2.0,ec='black')
cs0=axs[4].scatter(hldG75300.sel(time=slice(Tdateb[1],Tdatee[1])), hld75300.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs1=axs[4].scatter(hldG75300.sel(time=slice(Tdateb[2],Tdatee[2])), hld75300.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs2=axs[4].scatter(hldG75300.sel(time=slice(Tdateb[3],Tdatee[3])), hld75300.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs3=axs[4].scatter(hldG75300.sel(time=slice(Tdateb[4],Tdatee[4])), hld75300.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs4=axs[4].scatter(hldG75300.sel(time=slice(Tdateb[5],Tdatee[5])), hld75300.sel(time=slice(Tdateb[5],Tdatee[5])) , \
  c='w',s=90,marker='P',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
###
axs[5].scatter(hld075,hldG075, c='w' ,s=60,linewidth=2.0,edgecolors='black')
cs0=axs[5].scatter(hldG075.sel(time=slice(Tdateb[1],Tdatee[1])), hld075.sel(time=slice(Tdateb[1],Tdatee[1])) , \
  c='w',s=90,marker='*',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs1=axs[5].scatter(hldG075.sel(time=slice(Tdateb[2],Tdatee[2])), hld075.sel(time=slice(Tdateb[2],Tdatee[2])) , \
  c='w',s=90,marker='v',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs2=axs[5].scatter(hldG075.sel(time=slice(Tdateb[3],Tdatee[3])), hld075.sel(time=slice(Tdateb[3],Tdatee[3])) , \
  c='w',s=90,marker='^',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='c')
cs3=axs[5].scatter(hldG075.sel(time=slice(Tdateb[4],Tdatee[4])), hld075.sel(time=slice(Tdateb[4],Tdatee[4])) , \
  c='w',s=90,marker='X',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
cs4=axs[5].scatter(hldG075.sel(time=slice(Tdateb[5],Tdatee[5])), hld075.sel(time=slice(Tdateb[5],Tdatee[5])) , \
  c='w',s=90,marker='P',cmap='bwr',vmin=-3,vmax=3,linewidth=2.0,ec='m')
